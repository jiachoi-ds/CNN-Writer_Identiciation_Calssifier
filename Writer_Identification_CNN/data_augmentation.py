# (추가) data augmentation

import multiprocessing, os, time
from keras.preprocessing.image import ImageDataGenerator

''' SETTING '''
INPUT_DIR = "C:/PythonProject/IT_TermProject/distinction/train/"# your image data directory/
OUTPUT_DIR = 'C:/PythonProject/IT_TermProject/data_augmentation/train/'  # output images data directory/
IMAGE_FORMAT = 'jpg'  # output image format (jpeg, png)
FILE_NAME = 'aug'  # output image file name pre***.jpeg
IMAGE_SIZE = (64, 64)  # output image size
P_NUM = multiprocessing.cpu_count() # number of core
END_POINT = 3 # Number of images to be generated per image
